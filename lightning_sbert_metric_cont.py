...
class LSTM_model(pl.LightningModule):
	...
	def validation_epoch_end(self, val_step_outputs):
		...
		val_weighted_f1 = f1_score(val_targets, val_predictions, average='macro')
...
if __name__ == "__main__":
	...
	pretrained_dict = torch.load('/home/yzhan273/Research/MPAA/Severity_Class_Pred/metric_learning/metric_saved_model_'+ working_aspect +'.ckpt')   
